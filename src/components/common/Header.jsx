  ...
  return (
    <header className="flex justify-between h-[120px] bg-[#dd2b23]">
      ...
      <div className="flex gap-2.5 ml-20 items-center">
        ...
        />
        <p className="font-bold text-xl text-white cursor-pointer hover:text-[#ffe900] transition duration-[0.25s]">
          <Link to="/">
          FlyEase
          </Link>
        </p>
      ...
      <div className="flex w-1/2 items-center justify-center">
        <ul className="flex justify-center gap-16">
          <li className="list-none text-xl font-bold cursor-pointer text-white hover:text-yellow-100 duration-[0.25s]">
            <Link to="/">Inicio</Link>
          </li>
